...
<div class="container mx-auto mt-8 max-w-xl">
    <h2 class="text-2xl font-semibold mb-6 text-gray-800 dark:text-white">✏️ Editar Cliente</h2>
    ...
    <form action="{{ route('clientes.update', $cliente->cpf) }}" method="POST" class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md space-y-4">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <input type="text" name="cpf" id="cpf" value="{{ $cliente->cpf }}" readonly
        ...
        <div>
            ...
            <input type="text" name="nome" id="nome" required value="{{ old('nome', $cliente->nome) }}"
        ...
        <div>
            ...
            <input type="text" name="telefone" id="telefone" required value="{{ old('telefone', $cliente->telefone) }}"
                class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 dark:bg-gray-700 dark:text-white">
        </div>
        ...
        <div>
            ...
            <input type="email" name="email" id="email" required value="{{ old('email', $cliente->email) }}"
                class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 dark:bg-gray-700 dark:text-white">
        </div>
